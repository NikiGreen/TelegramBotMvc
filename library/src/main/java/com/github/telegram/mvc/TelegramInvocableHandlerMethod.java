...
class TelegramInvocableHandlerMethod extends HandlerMethod {
    ...
    private Object doInvoke(Object[] args) throws Exception {
        ...
        try {
            ...
            if (targetException instanceof RuntimeException) {
                ...
                String text = getInvocationErrorMessage("Failed to invoke telegram.mvc.handler method", args);
    ...
    private void assertTargetBean(Method method, Object targetBean, Object[] args) {
        ...
        if (!methodDeclaringClass.isAssignableFrom(targetBeanClass)) {
            String text = "The mapped telegram.mvc.handler method class '" + methodDeclaringClass.getName() +
